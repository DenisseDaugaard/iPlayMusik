...
export default function BackGroundPlayer() {
  ...
  return (
    <Link href={`/player/${id}`} prefetch={false}>
      <div className="z-50 fixed rounded-[50%] bottom-[12%] right-[8%] p-4 h-[4rem] w-[4rem] bg-[linear-gradient(159deg,rgba(255,17,104,0.98)_24%,rgba(241,141,5,1)_100%)] flex items-center justify-center hover:scale-110 cursor-pointer">
